...
FlectoneGrowth is a Minecraft server plugin that grows a player's in-game
...
- **PlaceholderAPI support.** A rich set of `%flectonegrowth_*%` placeholders
  ...
  documented in-game via `/papi info flectonegrowth`.
- **API for other plugins.** A typed, read-only Java API (`FlectoneGrowthAPI`)
...
- **FlectonePulse-aware.** If FlectonePulse is installed, FlectoneGrowth
...
- **Update notifications.** Checks GitHub once on startup for a newer
  ...
  `flectonegrowth.update-notify` (default: op) on join. Disable entirely with
...
|---|---|---|
| `/height <meters>` | Set your own custom height. | `flectonegrowth.height` |
| `/height remove` | Remove your custom height and resume natural growth. | `flectonegrowth.height` |
| `/height set <player> <meters>` | Set another player's custom height. | `flectonegrowth.height.others` |
| `/height remove <player>` | Remove another player's custom height. | `flectonegrowth.height.others` |
| `/gender <type>` | Set your own gender. | `flectonegrowth.gender` |
| `/gender set <player> <type>` | Set another player's gender. | `flectonegrowth.gender.others` |
| `/growth summary [player]` | View height, gender, and growth progress. | `flectonegrowth.info` / `.others` |
| `/growth height [player]` | View height and growth progress only. | `flectonegrowth.info` / `.others` |
| `/growth gender [player]` | View gender only. | `flectonegrowth.info` / `.others` |
| `/flectonegrowth reload` (alias `/pg reload`) | Reload config/gender/messages without a restart. | `flectonegrowth.admin.reload` |
| `/flectonegrowth help` (alias `/pg help`) | List every command available to you. | `flectonegrowth.help` |
...
its own `build/libs/` (e.g. `FlectoneGrowth-Bukkit-<version>.jar`) ready to
