package org.misqzy.playergrowth.paper.network;
 ...
 */
public final class PaperNetworkMessenger implements NetworkMessenger, PluginMessageListener {

    private final JavaPlugin plugin;
    private volatile Consumer<SyncMessage> handler;

    public PaperNetworkMessenger(JavaPlugin plugin) {
        this.plugin = plugin;
    }
