...
import org.misqzy.playergrowth.paper.BuildVersion;
 ...
 * {@link PaperPlayerAdapter} per call, same pattern every command class
...
public final class PlaceholderAPIHook extends PlaceholderExpansion {
    ...
    public String onRequest(@NotNull OfflinePlayer offlinePlayer, @NotNull String params) {
        ...
        PaperPlayerAdapter target = new PaperPlayerAdapter(player);
