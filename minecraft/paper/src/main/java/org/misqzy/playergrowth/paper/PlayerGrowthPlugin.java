...
import org.misqzy.playergrowth.paper.network.PaperNetworkMessenger;
...
public final class PlayerGrowthPlugin extends JavaPlugin {
    ...
    private PaperNetworkMessenger networkMessenger;
    ...
    private PlayerGrowthCore bootstrapCore() {
        ...
        if (mainConfig.getBoolean("network.sync-enabled", false)) {
            networkMessenger = new PaperNetworkMessenger(this);
    ...
    private PlatformPlayer findOnline(UUID uuid) {
        ...
        return player != null ? new PaperPlayerAdapter(player) : null;
    }
