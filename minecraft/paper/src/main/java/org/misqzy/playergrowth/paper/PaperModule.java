...
/**
 * Binds the Paper-specific implementations of the contracts
...
public final class PaperModule extends AbstractModule {
    ...
    public PaperModule(Scheduler scheduler, NetworkMessenger networkMessenger, PlayerLookup playerLookup) {
