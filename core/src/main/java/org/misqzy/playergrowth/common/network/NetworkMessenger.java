...
/**
 * Cross-server messenger contract. The Paper and Bukkit modules implement
 * this over Bukkit's plugin-messaging channels (which require a routed
 * connection through a proxy); the Velocity module only ever <b>relays</b>
 * bytes between backend servers, it never constructs/applies a
